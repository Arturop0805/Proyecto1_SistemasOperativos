...
public class Principal extends JFrame {
    ...
    private List<Proceso> historialProcesos = new ArrayList<>();
    ...
    private void mostrarPCB(Proceso p) {
        ...
        try { grid.add(new JLabel("Instrucciones:")); grid.add(new JLabel(p.getContadorPrograma() + " / " + p.getInstruccionesTotales())); } catch(Exception e) { grid.add(new JLabel("Instrucciones:")); grid.add(new JLabel("N/A")); }
